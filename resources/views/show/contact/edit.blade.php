      ...
      <div class="panel-body">
        <form action="{{ route('show.contact.update', ['contact' => $contact]) }}" method="POST" class="form-horizontal">
          ...
          <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
              <input id="name" name="name" type="text" class="form-control" value="{{ old('name', $contact->name) }}" autofocus required>
          ...
          <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
              <input id="description" name="description" type="text" class="form-control" value="{{ old('description', $contact->description) }}">
